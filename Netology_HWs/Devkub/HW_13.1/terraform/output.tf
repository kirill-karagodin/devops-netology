...
output "external_ip_address_cp01_yandex_cloud" {
  value = "${yandex_compute_instance.cp01.network_interface.0.nat_ip_address}"
}

output "internal_ip_address_cp01_yandex_cloud" {
  value = "${yandex_compute_instance.cp01.network_interface.0.ip_address}"
}
