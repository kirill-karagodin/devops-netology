...
node3 ansible_host=${yandex_compute_instance.node03.network_interface.0.nat_ip_address}  ip=${yandex_compute_instance.node03.network_interface.0.ip_address} ansible_user=centos
node4 ansible_host=${yandex_compute_instance.node04.network_interface.0.nat_ip_address}  ip=${yandex_compute_instance.node04.network_interface.0.ip_address} ansible_user=centos
...
calico_rr
    ...
    DOC
  filename = "../source/kubespray/inventory/netology-cluster/inventory.ini"
